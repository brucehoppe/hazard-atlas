...
Copyright © 2026 Bruce Hoppe is retained in source comments and LICENSE rather than displayed in the interface. Provider and geography credits remain visible; the About and Sources panels name the included MIT licence. Hazard Atlas does not imply NASA, USGS, GDACS, or University of Toronto endorsement.
