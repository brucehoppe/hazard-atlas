...
The withdrawn personal email footer credit is not present. The footer attribution is the copyright notice “© 2026 Bruce Hoppe,” carried as plain text rather than a repository link, alongside provider and geography credits; the About and Sources panels still link the source code and licence. Hazard Atlas does not imply NASA, USGS, GDACS, or University of Toronto endorsement.
